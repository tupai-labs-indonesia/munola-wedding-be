...
class InviteeController extends Controller
{
    ...
    public function create(InsertInviteeRequest $request): JsonResponse
    {
        ...
        $name = urlencode($name);
        $invitation = $request->base_url . "?to=" . str_replace(' ', '_', $request->name);
